...
<title>Admin Login Back | Modern-Gyan</title>
</head>
...
<body>
    ...
    <%
        ...
        try 
		{
            ...
            PreparedStatement pstmt=con.prepareStatement("SELECT COUNT(*) from AdminTb");
            ...
            if(c==0)
            {
                pstmt=con.prepareStatement("INSERT INTO AdminTb(admin_name,username,password) VALUES ('Chandrachud singh','ccsingh','6250')");
                pstmt.executeUpdate();
            }

            pstmt=con.prepareStatement("SELECT COUNT(*) from AdminTb WHERE username=? and password=?");
        ...
        if(c==1)
        {
            application.setAttribute("session_admin", user);
