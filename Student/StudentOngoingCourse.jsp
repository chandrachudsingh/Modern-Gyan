...
<title>Faculty Ongoing Courses | Modern-Gyan</title>
    <link rel="stylesheet" href="StudentOngoingCourse.css">
            ...
            <div class="OngoingCourses">
                ...
                <div class="Details2">
                    ...
                    <div>
                        ...
                        <input type="text" name="txMeetId<%=i%>" class="MeetingId Smallsize" value="<%= meeting_id[i] %>" readonly/>
                    </div>
                    <div>
                        <label name="lbMeetingPassword<%=i%>" class="lbcontent"> Meeting Password : </label> 
                        <input type="text" name="txMeetPass<%=i%>" class="MeetingPassword Smallsize" value="<%= meeting_password[i] %>" readonly/>
                    </div>
                </div>
            </div>
            <%

            if(meeting_id[i] == null || meeting_password[i] == null)
            {
                %><script>
                    document.getElementById("MeetId<%=i%>").value = "Not provided";
                    document.getElementById("MeetPass<%=i%>").value = "Not provided";
                </script><%
            }
        }
    %>
